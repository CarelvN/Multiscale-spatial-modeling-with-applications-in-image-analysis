__title__   =  'MSFM Distance comparison'
...
Res = list()
print('MSFM Distance compare n=5')
...
for Label in Classes:
	...
	Empty = Image[Image.keys()[90002:]].values.tolist()[0]
	Empty = np.array([[int(i) for i in e[1:-1].split(', ')] for e in Empty]).T
